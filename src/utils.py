    ...
    return [
        ...
        },
        {
            ...
            "content": (
                ...
                f"If the article reports extreme cases of sexual assault, reduce all scores by 0.4. "
                f"If the article reports incidents extremely localised to any province of India or any other country, increase the indian_local_news by score by 0.6. "
